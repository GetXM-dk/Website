        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
          <div className="text-left">
            ...
            <p className="mt-6 max-w-xl text-base text-muted-foreground md:text-lg">
              Når I må slippe telefonen, samler GetXM op med en automatisk SMS. Patienten kan forklare behovet, og
              klinikken får en klar besked om, hvem der ringede, hvad det handlede om, og hvad der skal ske nu.{" "}
            </p>
