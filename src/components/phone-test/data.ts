...
export const diagnosticMapping: Record<string, Record<string, Omit<DiagnosticCardData, "category">>> = {
  whoAnswers: {
    "Reception / kliniksekretær": {
      ...
      text: "Når telefonen ligger hos receptionen, har I et stærkere udgangspunkt end klinikker, hvor behandlerne selv skal tage den.",
      level: "green",
    },
    "Vi skiftes": {
      title: "Telefonen deles mellem flere",
      text: "Når flere skiftes til at tage telefonen, kan ansvar og opfølgning blive uklart i travle perioder.",
      level: "yellow",
    },
    "Behandlerne selv": {
      title: "Telefonen rammer behandlingen",
      text: "Når behandlerne selv tager telefonen, kan opkald koste ro, fokus og tid med patienten foran jer.",
      level: "red",
    },
  },
  frequency: {
    "Sjældent — vi føler, vi når det meste": {
      title: "I når det meste",
      text: "Telefonen ser ikke ud til at være en stor daglig afbrydelse hos jer.",
      level: "green",
    },
    "Indimellem — især i travle perioder": {
      title: "Telefonen forstyrrer i travle perioder",
      text: "Når der er pres på, kan opkald skabe afbrydelser og ekstra opfølgning senere.",
      level: "yellow",
    },
    "Ofte — vi kan mærke, at vi ikke når alle": {
      title: "Telefonen styrer for meget af dagen",
      text: "Hvis I ofte må afbryde arbejdet, koster opkald både ro, flow og behandlingsfokus.",
      level: "red",
    },
    "Vi ved det ikke — vi prioriterer patienten foran os": {
      title: "I mangler overblik over de opkald, I ikke når",
  ...
  followup: {
    "De bliver henvist til online booking": {
      title: "Patienten får en vej videre",
      text: "Online booking hjælper, men den fanger ikke nødvendigvis spørgsmål, afbud eller patienter, der har brug for hjælp først.",
      level: "green",
    },
    "De kan lægge en besked": {
      title: "Opfølgning flyttes til senere",
    ...
    "De må prøve igen i vores telefontid": {
      title: "Patienten kan falde fra",
      text: "Når patienten selv skal prøve igen, er der risiko for, at henvendelsen aldrig bliver til en booking.",
      level: "red",
    },
    "Andet": {
      title: "Næste skridt kan være uklart",
      text: "Hvis patienten ikke får en tydelig vej videre, kan henvendelsen let blive tabt.",
      level: "yellow",
    },
  },
  painPoint: {
    "Nye patienter ikke kommer igennem": {
      title: "Nye patienter kan vælge næste klinik",
    ...
    "Ubesvarede opkald ikke bliver fulgt op": {
      title: "Henvendelser bliver usynlige",
      text: "I ved ikke, om opkaldet var en ny booking, et afbud, et spørgsmål eller noget vigtigt.",
      level: "red",
    },
    "Dårlig første oplevelse for patienten": {
      title: "Første kontakt føles svær",
    ...
    "Telefonen afbryder behandlinger": {
      title: "Telefonen stjæler ro fra behandlingen",
    ...
    "Simple spørgsmål tager for meget tid": {
      title: "Praktiske spørgsmål fylder for meget",
