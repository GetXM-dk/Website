...
const Navbar = () => {
  return (
    <header className="fixed h-14 inset-x-0 top-3 z-40 px-3 md:top-4 md:px-6">
      {/* Jeg har ændret max-w-5xl til max-w-3xl for en smallere bar */}
      <div className="mx-auto flex h-14 max-w-3xl items-center gap-4 rounded-full border border-border/40 bg-background/70 pl-5 pr-2 shadow-soft backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 md:h-14 md:pl-6 md:pr-2.5">
