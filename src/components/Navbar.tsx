...
const Navbar = () => {
  return (
    <header className="fixed inset-x-0 top-3 z-40 px-3 md:top-4 md:px-6">
      <div className="mx-auto flex h-12 max-w-5xl items-center gap-4 rounded-full border border-border/40 bg-background/70 pl-5 pr-2 shadow-soft backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 md:h-14 md:pl-6 md:pr-2.5">
